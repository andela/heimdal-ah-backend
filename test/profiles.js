    ...
    it('should return status code 200 on updating a users profile', async () => {
      const res = await chai.request(app)
        ...
        .send({
          ...
          address: 'Surulere, lagos',
          dateofbirth: '09-10-1990',
          token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwidXNlcm5hbWUiOiJuZXdVc2VycyIsImlhdCI6MTUxNjIzOTAyMn0.55awbcnFaZ0wok7ITlVY609olXEhT8zJxdpPGJTzjrI'
        });
      res.status.should.equal(200);
      res.body.should.be.a('object');
      res.body.should.have.property('message');
